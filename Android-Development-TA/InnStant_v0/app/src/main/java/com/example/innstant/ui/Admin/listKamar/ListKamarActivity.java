package com.example.innstant.ui.Admin.listKamar;
...
import com.example.innstant.ui.Admin.Adapter.AdapterListKamar;
...
public class ListKamarActivity extends AppCompatActivity implements AdapterListKamar.OnItemClickListener {


    @BindView(R.id.back)
    ImageView back;
    @BindView(R.id.ListKamar)
    RecyclerView ListKamar;
    @BindView(R.id.fab)
    FloatingActionButton fab;
    private ListerRoomVewModel mViewModel;
    RecyclerView recyclerView;
    AdapterListKamar adapter;
    ArrayList<Room> list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListKamar.setLayoutManager(new LinearLayoutManager(this));
        layoutManager = new LinearLayoutManager(this);
        ListKamar.setLayoutManager(layoutManager);
        ButterKnife.bind(this);
                ...
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            ...
                            use = new Gson().fromJson(String.valueOf(jsonObject), Room.class);
                            list.add(use);

                        }

                        adapter = new AdapterListKamar(ListKamarActivity.this, list, ListKamarActivity.this);
                        ListKamar.setAdapter(adapter);
                    }
...
//                    headers.put("Authorization", "Bearer " + "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJpc3MiOiJzZWN1cmUtYXBpIiwiYXVkIjoic2VjdXJlLWFwcCIsInN1YiI6InJvaG1hdDY2MUBnbWFpbC5jb20iLCJleHAiOjE1NjI2NjM1NjksInJvbGUiOlsiVVNFUiJdfQ.6mGlnlu0lWHuOZLmy_I4IYOD5BJKc-22fbR0sWO-8j_KQ9Jkk4owJZqpP3yPtvBIiRhD_zRYKm-ew3DPqFrK_A");
    ...
    public void onItemClick(Room item) {
        Toast.makeText(ListKamarActivity.this, item.toString(), Toast.LENGTH_LONG).show();
    }
}
